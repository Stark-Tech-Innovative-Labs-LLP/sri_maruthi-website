...
<center>
  ...
  <div class="card-body">
    ...
    <a href="Materials?class=LANG"  class="btn btn-danger">View</a>
  </div>
</div></div> 
<div class="col-lg-4"><div class="card" style="width: 18rem;">
  <img src="https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2020/07/solar_orbiter_s_first_view_of_the_sun2/22133123-1-eng-GB/Solar_Orbiter_s_first_view_of_the_Sun_pillars.png" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <a href="Materials?class=PUSC"  class="btn btn-danger">View</a>
  </div>
</div></div>
        <div class="col-lg-4"><div class="card" style="width: 18rem;">
  <img src="https://www.esa.int/var/esa/storage/images/esa_multimedia/images/2020/07/solar_orbiter_s_first_view_of_the_sun2/22133123-1-eng-GB/Solar_Orbiter_s_first_view_of_the_Sun_pillars.png" class="card-img-top" alt="...">
  ...
  <h5 class="card-title">Commerece Study Materials [PUC]</h5>
    <a href="Materials?class=PUCM"  class="btn btn-primary">View</a>
  </div>
</div></div>
    </div>
  ...
  <div class="card-body">
    ...
    <a href="Materials?class=DEG"  class="btn btn-success">View</a>
  </div>
</div></div>
<div class="col-lg-3"></div>
